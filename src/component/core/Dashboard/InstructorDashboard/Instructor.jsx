...
//                   <p className="text-xs font-semibold text-yellow-300">View All</p>
//                 </Link>
//               </div>
...
//               <p className="mt-1 text-center text-lg font-semibold text-yellow-300">
//                 Create a course
//               </p>
//             </Link>
//           </div>
      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="my-4 flex flex-col gap-4 lg:flex-row">
            ...
            {/* Statistics */}
            <div className="w-full lg:max-w-[300px] rounded-md bg-richblack-800 p-6">
              <p className="text-lg font-bold text-richblack-5">Statistics</p>
              <div className="mt-4 space-y-4">
                <div>
                  <p className="text-lg text-richblack-200">Total Courses</p>
              ...
              {courses.slice(0, 3).map((course) => (
                <div key={course._id}>
                  <img
                    src={course.thumbnail}
                    alt={course.courseName}
                    className="h-[180px] w-full rounded-md object-cover sm:h-[200px]"
                  />
                  <div className="mt-3">
                    <p className="text-sm font-medium text-richblack-50">
                      {course.courseName}
